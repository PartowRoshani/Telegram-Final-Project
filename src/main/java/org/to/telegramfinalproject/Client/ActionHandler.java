...
//                    }
                ...
                case "update_profile_picture":
                    if (status.equals("success")) {
                        ...
                        Session.currentUser.put("image_url", response.getJSONObject("data").getString("image_url"));
                    } else {
                        System.out.println("Failed to update profile picture: " + response.getString("message"));
                    }
                    break;
...
//                                }
    ...
    public void userMenu(UUID internal_uuid) throws IOException {
        while (true) {
            ...
            System.out.println("6. Show sidebar menu");
...
//    }
    ...
    public void updateProfilePicture(String imageUrl) {
        JSONObject request = new JSONObject();
        request.put("action", "update_profile_picture");
        request.put("user_id", Session.currentUser.getString("user_id"));
