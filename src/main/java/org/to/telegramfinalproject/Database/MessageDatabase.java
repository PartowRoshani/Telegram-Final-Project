        ...
        try (Connection conn = ConnectionDb.connect();
            ...
            if (rs.next()) {
                Message msg = new Message(
                        ...
                        rs.getString("status"),
                        rs.getString("reply_to_id") != null ? UUID.fromString(rs.getString("reply_to_id")) : null,
                        rs.getBoolean("is_edited"),
                        rs.getString("original_message_id") != null ? UUID.fromString(rs.getString("original_message_id")) : null,
                        rs.getString("forwarded_by") != null ? UUID.fromString(rs.getString("forwarded_by")) : null,
                        rs.getString("forwarded_from") != null ? UUID.fromString(rs.getString("forwarded_from")) : null
                );
                return msg;
            }
        } catch (SQLException e) {
